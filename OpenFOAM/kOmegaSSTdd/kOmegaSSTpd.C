...
namespace Foam
{
    namespace RASModels
    {
        ...
        void kOmegaSSTpd<BasicTurbulenceModel>::correctNut(const volScalarField &S2)
        {
        ...
        template <class BasicTurbulenceModel>
        void kOmegaSSTpd<BasicTurbulenceModel>::correctNut()
        {
        ...
        template <class BasicTurbulenceModel>
        kOmegaSSTpd<BasicTurbulenceModel>::kOmegaSSTpd(
        ...
        // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
        template <class BasicTurbulenceModel>
        void kOmegaSSTpd<BasicTurbulenceModel>::correct()
        {
            if (!this->turbulence_)
            {
                return;
            ...
            Info << "--------------------------------------------------------------------------" << endl;
            Info << "This is a modified version of kOmegaSST to account for pressure dilatation" << endl;
            Info << "--------------------------------------------------------------------------" << endl;
